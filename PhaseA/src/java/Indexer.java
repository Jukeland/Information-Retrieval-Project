...
public class Indexer{
    ...
    private static final int DOCUMENT_THRESHOLD = 10000;
    ...
    public static void main(String[] args) throws IOException{
        ...
        //File folder = new File(System.getProperty("user.dir") + "\\src\\resources\\MiniCollection");
...
//        }
    ...
    public static void loadStopwords() throws IOException{
        ...
        stopwordsEn = new HashSet<>(Files.readAllLines(new File(System.getProperty("user.dir") + "\\src\\resources\\stopwordsEn.txt").toPath(), StandardCharsets.UTF_8));
        stopwordsGr = new HashSet<>(Files.readAllLines(new File(System.getProperty("user.dir") + "\\src\\resources\\stopwordsGr.txt").toPath(), StandardCharsets.UTF_8));
